  ...
  export default defineAppConfig({
    config: {
      ...
      footer: {
        ...
        darkLogo: "images/logo-dark.svg",
        hideEmailBox: false,
        emailAPI: "https://api.azpays.net/api/Email/ContactUs",
        copyRight: `<span>© 2017-2023
                              <a href="https://azpays.net" class="hover:underline">Azpays</a>.
        ...
        socials: [
          {
            ...
            link: "https://twitter.com/azpaysapp",
          },
  
          {
            icon: "mdi:instagram",
            link: "https://www.instagram.com/azpaysapp",
          },
          {
            icon: "mdi:linkedin",
            link: "https://www.linkedin.com/company/azpaysapp",
          },
          {
            icon: "mdi:youtube",
