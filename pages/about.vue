    ...
    <div
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <p
          ...
          models, algorithms, risk programs on Azpays
        </p>
      </div>
      <div
    ...
    <div
      ...
      <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
        ...
        <p class="mb-4">
          ...
          software. Thus, Azpays was born.The team worked tirelessly day and
          ...
          Azpays. The software was an instant hit, and traders from all over the
          world flocked to it.
          <br />
          Today, Azpays is a global brand, with three major offices around the
          ...
          their technical skills, but also their determination and passion. They
          are grateful for the opportunity to have started their business from
          the AI lab at their university, and they hope to inspire other young
          entrepreneurs to pursue their dreams and make their mark in the world.
        </p>
      </div>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="grid gap-8 lg:grid-cols-2">
        <NuxtLink
          ...
          <span class="w-full">Explore Azpays Open Positions</span>
          <svg
            class="ml-3 w-6 h-6"
            fill="currentColor"
            viewBox="0 0 20 20"
